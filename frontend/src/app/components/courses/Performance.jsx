        ...
        <div className="relative w-full px-4 sm:px-6 lg:px-12 xl:px-24 2xl:px-40 py-12  flex flex-col lg:flex-row items-center gap-4 xl:gap-12 bg-cover bg-center overflow-hidden">
          ...
          <div className="relative w-full lg:w-1/2 z-10 px-2 sm:px-0">
            ...
            <h1 className="bungee-shade-regular text-3xl sm:text-4xl md:text-5xl  xl:text-7xl text-[#000000] leading-tight">
              Master Performance Marketing & Career in 4 Weeks
            </h1>

            {/* Description */}
            <div className="text-sm sm:text-base md:text-lg my-4 sm:my-6">
              <p>
              Learn paid ads, campaign strategy, and conversion optimization in 4 weeks with our performance marketing course designed for practical, result-focused digital marketing careers.
...
Performance marketing course after 12th students trust Digital Paaji for practical ad training and live campaign experience. Our performance marketing training focuses on real ROI-based marketing strategies, helping students master ad platforms, targeting, and conversion optimization with industry tools.
              ...
              <div className="bg-linear-to-br from-[#e9872436] via-transparent to-[#e9872428] rounded-xl p-6 md:p-8 text-center ">
                ...
                <p className="text-base text-gray-800">
                  Build an impressive portfolio while learning. This is an ideal
                   Performance Marketing course after 12th for students who want
          ...
          <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 xl:px-24  2xl:px-40 bg-black">
           ...
           Performance marketing is a high-income digital skill. Our performance marketing course helps students build strong freelancing, job, and business growth opportunities with real campaign experience.
 ...
 Starting Salary: ₹3.0 – ₹5.0 LPA
          ...
          <div className="bg-linear-to-b from-[#e9872436] via-transparent to-[#e9872415] py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 xl:px-24  2xl:px-40">
            ...
            Learn ad psychology, audience targeting, funnel strategy, and performance tracking. Our performance marketing training focuses on real business campaign results and ROI optimization strategies.
...
Learn customer psychology, buying triggers, and audience targeting strategies. Core concept taught in performance marketing training programs.
                    </p>
                  </div>
                </div>
              ...
              Landing Page Optimization
                    ...
                    <p className="text-gray-600">
          Learn landing page design, conversion elements, and user behavior optimization. Important skill in performance marketing course after 12th training.
                ...
                <div className="relative group cursor-pointer">
                  ...
                  Meta Ads (Facebook & Instagram Ads)
                    ...
                    <p className="text-gray-600">
       Learn ad creation, targeting, budget control, and performance tracking. Covered in a performance marketing course for social ad campaigns.
...
Online Advertising & Google Ads
                    ...
                    <p className="text-gray-600">
     Learn search ads, keyword targeting, and bidding strategies. Practical module included in performance marketing training programs.
                ...
                <div className="relative group cursor-pointer">
                  ...
                  <div className="relative  bg-white rounded-xl p-6 md:p-8 text-center border border-black transition-all duration-300 group-hover:top-0.5 group-hover:left-1 h-[280px] md:h-[360px] 2xl:h-[320px] flex flex-col gap-2 items-center justify-center">
                    ...
                    <h4 className="poppins text-xl xl:text-2xl group-hover:text-[#e98724]">
                Google Ad Campaign Case Study

                    </h4>

                    <p className="text-gray-600">
 Learn real campaign structure, ad copy strategy, and performance analysis. Core module in performance marketing course after 12th learning.
...
Display Advertising
                    ...
                    <p className="text-gray-600">
            Learn banner ads, targeting strategies, and brand visibility campaigns. Taught in performance marketing course practical modules.
          ...
          <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 xl:px-24 2xl:px-40 bg-linear-to-b from-[#e9872436] via-transparent to-[#e9872415]">
           ...
           Who can join this course?
                    ...
                    Anyone interested in paid ads, digital marketing, or online business growth can join, including students after 12th.
       ...
       Is placement support provided?
                    ...
                    <div className="px-6 pb-6 text-gray-600">
               Yes, we provide portfolio guidance, campaign practice, and interview preparation.
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                  <details className="group">
                   ...
                   Do I need my own laptop?
                    ...
                    <div className="px-6 pb-6 text-gray-600">
   Yes, having your own laptop is recommended for ad practice and campaign setup.
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                  <details className="group">
                    <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                      <span className="poppins text-lg md:text-xl font-semibold text-gray-900">
 Are there live campaign case studies?
                    ...
                    <div className="px-6 pb-6 text-gray-600">
                   Yes, you will learn through real campaign case studies and performance analysis training.
