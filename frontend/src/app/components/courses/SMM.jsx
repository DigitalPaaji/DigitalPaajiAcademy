...
function InnerBanner({ heading }) {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfUrl = "/Images/pdf/smm.pdf";
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "SMM_Syllabus.pdf"; // Name of the downloaded file
        ...
        <div className="relative w-full px-4 sm:px-6 lg:px-12 xl:px-24 2xl:px-40 py-12  flex flex-col lg:flex-row items-center gap-4 xl:gap-12 bg-cover bg-center overflow-hidden">
          ...
          <div className="relative w-full lg:w-1/2 z-10 px-2 sm:px-0">
            ...
            <h1 className="bungee-shade-regular text-3xl sm:text-4xl md:text-5xl  xl:text-7xl text-[#000000] leading-tight">
              Master Social Media Marketing & Career in 1 Months
            ...
            <div className="text-sm sm:text-base md:text-lg my-4 sm:my-6">
              <p>
    Join the most practical Social Media Marketing course in Patiala and learn how to grow brands online using real strategies. This short-term program covers content creation, platform marketing, and campaign basics, making it perfect for beginners, students, and professionals who want quick, career-ready skills.
        ...
        <div className="bg-white">
          ...
          <div className="bg-linear-to-b from-[#e9872436] via-transparent to-[#e9872415] py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 xl:px-24  2xl:px-40">
           ...
           Digital Paaji is a leading social media marketing institute focused on practical training and job-ready skills. If you are looking for a Social Media Marketing course in Patiala, our program is designed for beginners, students, and business owners. This Social Media Marketing course after 12th helps you start a digital career without needing technical background.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 mt-12 md:mt-16">
              ...
              <div className="bg-linear-to-br from-[#e9872436] via-transparent to-[#e9872428] rounded-xl p-6 md:p-8 text-center ">
                ...
                <p className="text-base text-gray-800">
                  ...
                  SMM course after 12th for students who want
          ...
          Joining our Social Media Marketing course in Patiala is an investment in a high-demand skill. After completing this Social Media Marketing course after 12th, students can work in agencies, companies, or start freelancing. As a trusted social media marketing institute, we focus on real project experience.
          ...
          Career scope is strong because every business needs social media presence, brand promotion, and online customer engagement experts.
 Starting Salary: ₹2 LPA - ₹4 LPA
              </p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
              {[
                { title: " Social Media Manager", icon: "/Images/course/dmspecialist/9.png" },
                { title: "Content Creator", icon: "/Images/course/idea.png" },
                {
          ...
          <div className="bg-linear-to-b from-[#e9872436] via-transparent to-[#e9872415] py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 xl:px-24  2xl:px-40">
            <div className="text-center">
              ...
              Our Social Media Marketing course after 12th covers platform strategies, content creation, and paid ads. This Social Media Marketing course in Patiala is designed by industry experts at our social media marketing institute to make you job-ready.
  ...
  <div className="relative group cursor-pointer">
    ...
    <div className="relative bg-white rounded-xl p-6 md:p-8 text-center border border-black transition-all duration-300 group-hover:top-0.5 group-hover:left-1 h-[280px] md:h-[360px] 2xl:h-[320px] flex flex-col gap-2 items-center justify-center">
      <img src="/Images/course/canva.png" className="w-16 h-16 mx-auto mb-4 group-hover:scale-110 transition" />
      <h4 className="poppins text-xl xl:text-2xl group-hover:text-[#e98724]">
        Canva Graphic Design
      </h4>
      <p className="text-gray-600">
        Create stunning visuals with Canva <br />
        Design posts, banners & presentations <br />
  ...
  <div className="relative group cursor-pointer">
    ...
    <div className="relative bg-white rounded-xl p-6 md:p-8 text-center border border-black transition-all duration-300 group-hover:top-0.5 group-hover:left-1 h-[280px] md:h-[360px] 2xl:h-[320px] flex flex-col gap-2 items-center justify-center">
      <img src="/Images/course/video1.png" className="w-16 h-16 mx-auto mb-4 group-hover:scale-110 transition" />
      <h4 className="poppins text-xl xl:text-2xl group-hover:text-[#e98724]">
        Video Marketing
      </h4>
      <p className="text-gray-600">
        Plan & produce engaging videos <br />
        Editing basics & storytelling <br />
  ...
  <div className="relative group cursor-pointer">
    <div className="absolute top-2 left-2 w-full h-full bg-black rounded-xl transition-all duration-500 group-hover:top-1 group-hover:left-1.5" />
    <div className="relative bg-white rounded-xl p-6 md:p-8 text-center border border-black transition-all duration-300 group-hover:top-0.5 group-hover:left-1 h-[280px] md:h-[360px] 2xl:h-[320px] flex flex-col gap-2 items-center justify-center">
      <img src="/Images/course/seo.png" className="w-16 h-16 mx-auto mb-4 group-hover:scale-110 transition" />
      <h4 className="poppins text-xl xl:text-2xl group-hover:text-[#e98724]">
        Introduction to Social Media
      </h4>
      <p className="text-gray-600">
        Overview of major platforms <br />
        Audience behavior & strategies <br />
  ...
  <div className="relative group cursor-pointer">
    <div className="absolute top-2 left-2 w-full h-full bg-black rounded-xl transition-all duration-500 group-hover:top-1 group-hover:left-1.5" />
    <div className="relative bg-white rounded-xl p-6 md:p-8 text-center border border-black transition-all duration-300 group-hover:top-0.5 group-hover:left-1 h-[280px] md:h-[360px] 2xl:h-[320px] flex flex-col gap-2 items-center justify-center">
      <img src="/Images/course/video.png" className="w-16 h-16 mx-auto mb-4 group-hover:scale-110 transition" />
      <h4 className="poppins text-xl xl:text-2xl group-hover:text-[#e98724]">
        Facebook Business Marketing
      </h4>
      <p className="text-gray-600">
        Manage Facebook business pages <br />
        Run targeted ad campaigns <br />
        Track analytics & grow reach
      </p>
    </div>
  </div>
  ...
  <div className="relative group cursor-pointer">
    <div className="absolute top-2 left-2 w-full h-full bg-black rounded-xl transition-all duration-500 group-hover:top-1 group-hover:left-1.5" />
    <div className="relative bg-white rounded-xl p-6 md:p-8 text-center border border-black transition-all duration-300 group-hover:top-0.5 group-hover:left-1 h-[280px] md:h-[360px] 2xl:h-[320px] flex flex-col gap-2 items-center justify-center">
      <img src="/Images/course/dmspecialist/9.png" className="w-16 h-16 mx-auto mb-4 group-hover:scale-110 transition" />
      <h4 className="poppins text-xl xl:text-2xl group-hover:text-[#e98724]">
        Twitter Marketing
      </h4>
      <p className="text-gray-600">
        Build brand voice on Twitter <br />
        Use hashtags & trends effectively <br />
        Grow loyal audience & visibility
      </p>
    </div>
  </div>
          ...
          <div className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 xl:px-24 2xl:px-40 bg-linear-to-b from-[#e9872436] via-transparent to-[#e9872415]">
            <div className="max-w-4xl mx-auto">
             ...
             Who can join this Social Media Marketing course after 12th?
              ...
              Anyone after 12th, college students, job seekers, or business owners can join this course.
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                  <details className="group">
                    <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                      <span className="poppins text-lg md:text-xl font-semibold text-gray-900">
                Is this Social Media Marketing course in Patiala beginner friendly?
                    ...
                    <div className="px-6 pb-6 text-gray-600">
             Yes, our course starts from basics and moves to advanced marketing strategies.
                    </div>
                  </details>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                  <details className="group">
                    <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                      <span className="poppins text-lg md:text-xl font-semibold text-gray-900">
Why choose this social media marketing institute?
                    ...
                    <div className="px-6 pb-6 text-gray-600">
                    We provide practical training, live projects, and career guidance.
                    </div>
                  </details>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                  <details className="group">
                    <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                      <span className="poppins text-lg md:text-xl font-semibold text-gray-900">
           What career options after Social Media Marketing course after 12th?
                    ...
                    <div className="px-6 pb-6 text-gray-600">
         You can become Social Media Manager, Ads Specialist, Content Strategist, or Freelancer.
