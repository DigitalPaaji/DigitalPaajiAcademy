...
function Banner() {
  ...
  return (
    <div className="  bg-[#FF850D] mx-4 md:mx-12 xl:mx-24 
    ">
      <div className=" flex items-center justify-center">
        <div className="text-center ">
          <h1 className="laila-bold font-bold text-5xl md:text-6xl leading-tight tracking-tight">
        {words.map((word, index) => (
          ...
          <p className="text-xl poppins my-6 text-justify 2xl:mx-40">
    ...
    Paaji didn’t want to just build brands — he wanted to build people too.
          ...
          <p className="poppins text-md sm:text-lg font-medium">
            Paaji didn’t just build brands—he builds people too.
          </p>
